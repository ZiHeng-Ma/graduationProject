        ...
        <div class="row">
            ...
            <div id="content-wrapper">
                <div class="main-box clearfix" style="padding: 30px;">
                    <form role="form" action="${pageContext.request.contextPath}/function/toPageScoreMinerMain">
                        <div class="form-group">
                            <label for="Input1">最小支持度</label>
                            <input type="text" class="form-control" id="Input1" name="Input1" placeholder="请输入数字" style="width: 25%;">
                        </div>
                        <div class="form-group">
                            <label for="Input2">最小置信度</label>
                            <input type="text" class="form-control" id="Input2" name="Input2" placeholder="请输入数字" style="width: 25%;">
                        </div>
                        <div align="Left" style="margin-bottom: 10px;margin-left: 20px;">
                            <font size="4" color="red">可能需要点时间，请耐心等待</font>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
